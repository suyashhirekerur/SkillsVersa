        ...
        >
          {users.map(user => (
            <motion.div 
              ...
              key={user._id} 
              className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm hover:shadow-lg hover:border-white/30 transition-all group"
            >
              <div className="flex items-center space-x-4 mb-4">
                <div className="w-16 h-16 rounded-full bg-primary-900/50 flex items-center justify-center overflow-hidden border-2 border-primary-500/30">
                  {user.avatar ? (
                ...
                <div>
                  <h3 className="text-lg font-bold text-white group-hover:text-primary-400 transition-colors">{user.name}</h3>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {user.skills?.teach?.map((skill, idx) => (
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {user.skills?.learn?.map((skill, idx) => (
              ...
              <div className="mt-6 pt-4 border-t border-white/10 flex justify-end">
                <button className="text-sm font-medium text-primary-400 hover:text-primary-300 transition-colors flex items-center">
